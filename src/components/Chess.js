    ...
    return (
      <div className="App container">
              <ChessBoard
                ...
                tileSize={this.props.tileSize ? this.props.tileSize : "30px"}
                tile1color={this.props.tile1color ? this.props.tile1color : "white"}
                tile2color={this.props.tile2color ? this.props.tile2color : "lightblue"}
                highlight={this.props.highlight ? this.props.highlight : "blue"}
                pieceSize={this.props.pieceSize ? this.props.pieceSize : "20px"}
                pieceColor={this.props.pieceColor ? this.props.pieceColor : "black"}
              />
      </div>
    );
  }
